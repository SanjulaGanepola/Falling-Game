...
void setup() {
  ...
  img = loadImage("Images/mmr34.jpg");
  img.resize(800, 500);
  flower = loadImage("Images/flower.gif");
  flower.resize(40, 40);
  basket = loadImage("Images/basket.gif");
  basket.resize(150, 100);
  game = loadImage("Images/Game Over1.jpg");
  game.resize(800, 500);

  //load the sound into memory
  caught = minim.loadFile("Sounds/caught.mp3");
  missed = minim.loadFile("Sounds/missed.mp3");
...
void draw() {
  if (r == false) {//begins game   
    ...
    if ((b1>320)&&(b1<370)&&(a1>x-10)&&(a1<x+160)) {//catch statement
    ...
    if ((b2>320)&&(b2<370)&&(a2>x-10)&&(a2<x+160)) {//catch statement
    ...
    if ((b3>320)&&(b3<370)&&(a3>x-10)&&(a3<x+160)) {//catch statement
    ...
    if ((b4>320)&&(b4<370)&&(a4>x-10)&&(a4<x+160)) {//catch statement
    ...
    if ((b5>320)&&(b5<370)&&(a5>x-10)&&(a5<x+160)) {//catch statement
    ...
    line(168, 5, 168, 35);//seperates caught and missed
  }
  ...
  if (r == true) {//end game selection
    ...
    fill(0);//sets colour
    text("Play Again", 167, 335);//displays Play Again
    ...
    if (mouseX > 160 && mouseX < 310 && mouseY > 300 && mouseY < 350 && mousePressed) {//Play Again Button 
      ...
      b1 = int(random(-200, 0)+1);//b of flower 1
      b2 = int(random(-200, 0)+1);//b of flower 2
      b3 = int(random(-200, 0)+1);//b of flower 3
      b4 = int(random(-200, 0)+1);//b of flower 4
      b5 = int(random(-200, 0)+1);//b of flower 5
